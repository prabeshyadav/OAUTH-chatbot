...
import { Cpu, User, Lock, ArrowRight, Info } from 'lucide-react';
import { loginWithPassword, API_BASE } from '../api';
    ...
    <div className="modal-overlay">
      <div className="modal-card glass-panel">
        <div className="modal-header">
          ...
          <h2>Welcome Back</h2>
          <p>Sign in to access your AI Chatbot & Document RAG Workspace</p>
        </div>
        ...
        <a href={`${API_BASE}/auth/login`} className="btn btn-google btn-block">
        ...
        <div className="auth-hint">
          <Info size={16} />
          <span>Default Credentials: <code>admin</code> / <code>password123</code></span>
        </div>
      </div>
    </div>
  );
